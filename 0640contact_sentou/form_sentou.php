...
if (isset($_POST) && !empty($_POST)) {
	...
	//カナ入力チェック
	if (empty($kana)) {
		$errors[] = '<font color="FF0000">お名前(カタカナ)</font>を入力して下さい';
	}
	//ご住所入力チェック
	if (empty($address)) {
...
})(window,document,'script','dataLayer','GTM-MN6HQST');
</script>
	
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>銭湯サポート倶楽部のお問い合わせ | 株式会社アミックス</title>
...
<li id="item01"><a href="../index.html">ホーム</a></li>
			<li id="item02"><a href="../application/0100tochikatu.html">資産の活用</a></li>
			...
			<li id="item06"><a href="../nyukyosya/0400nyukyosya.html">入居者様サイト</a></li>
			<li id="item07"><a href="../0500faq.html">よくある質問</a></li>
			<li id="item08_f"><a href="../0600contact_top.html">お問い合わせ</a></li>
...
<img src="../common/img/main_visual/0600contact_top.jpg" width="675" height="216" alt="お問い合わせ　資料請求　お問い合わせ内容による受付窓口が異なりますので、ご確認ください。" id="mainVisualImg" /> </div>
	<ul class="topicPath">
<li class="pathStart"><a href="../index.html">ホーム</a></li><li><a href="../0600contact_top.html">お問い合わせ 資料請求</a></li><li class="this"><a href="../0640contact_sentou">銭湯サポート倶楽部のお問い合わせ</a></li>
	</ul>
	<!--contentsここから-->
	<div id="contents">
		<div id="sideContents">
			<h2 id="contactNaviTop"><a href="../0600contact_top.html">お問い合わせ 資料請求</a></h2>
			<ul id="contactNavi" class="sideNavi">
				<li id="sideNavi02" class="contactNavi02"><a href="../0620contact_shiryo">アパート建築のお問い合わせ・資料請求</a></li>
				<li id="sideNavi04_f"><a href="../0640contact_sentou">銭湯サポート倶楽部のお問い合わせ</a></li>
				<li id="sideNavi03"><a href="../0630contact_nyukyosya">入居者様のお問い合せ</a></li>
			</ul>
			<div id="sideBtn">
		...
		<div id="mainContents">
			<h2><img src="../common/img/contact/tit_contact09.gif" width="435" height="27" alt="銭湯サポート倶楽部のお問い合わせ" /></h2>
			<p class="mainText03">下記の内容でよろしければ、「送信」ボタンを押してください。<br /><span class="t14">（<span class="formRequired">※</span>は必須項目になります。）</span></p>
			<div id="contactForm">
				...
				<form action="./sendmail.php" method="post">
					...
					<input type="hidden" name="enquete" value="<?php echo $enquete ?>" />
					<input type="hidden" name="enquete_other" value="<?php echo $enquete_other ?>" />
					...
					<table>
						...
						<tr>
							<th><span>■</span>建築をご検討中の地域</th>
							<td><?php echo $examination ?></td>
						</tr>
						<tr>
							<th><span>■</span>お問い合わせ内容<span class="formRequired">※</span></th>
							<td><?php echo $message ?></td>
						</tr>
						<tr>
							<th><span>■</span>アンケート</th>
							<td><?php echo $enquete ?></td>
						</tr>
					</table>
					<p class="contactFormBtn">
...
<li class="pathStart"><a href="index.html">ホーム</a></li><li><a href="../0600contact_top.html">お問い合わせ 資料請求</a></li><li class="this"><a href="../0640contact_sentou">銭湯サポート倶楽部のお問い合わせ</a></li>
	...
	<div id="footerNavi">
        ...
        <div class="naviBox start">
            <dl>
                <dt><a href="../application/0100tochikatu.html">資産の活用TOP</a></dt>
            ...
            <dl>
                <dt><a href="../build/0200kenchiku.html">アパート建築TOP</a></dt>
                ...
                <dd><a href="../build/0294hoikuen.html">保育園建築</a></dd>
        ...
        <div class="naviBox">
            <dl>
                <dt><a href="../build/b0201reform.html">リフォームTOP</a></dt>
                <dd><a href="../b0201reform/">リフォーム事例[外観]</a></dd>
                <dd><a href="../b0201reform/interior">リフォーム事例[内装]</a></dd>
                <dd><a href="../0500faq.html#faqBuild">よくあるご質問</a></dd>
            </dl>
            <dl>
                <dt><a href="../manage/0300sublease.html">サブリース管理TOP</a></dt>
        ...
        <div class="naviBox">
            <dl>
                 <dt><a href="../sentoukura/0040sentou.html">銭湯サポート倶楽部TOP</a></dt>
            ...
            <dl>
                 <dt><a href="../nyukyosya/0400nyukyosya.html">入居者様向けTOP</a></dt>
                 <dd><a href="../0600contact_top.html">専用お問い合わせ</a></dd>
                 <dd><a href="../https://amix-club.jp/app/pc/index.html" target="_blank">アミックスクラブ</a></dd>
                 <dd><a href="../campaign/50th/room_top.html">部屋コン</a></dd>
            </dl>
            <dl>
                 <dt><a href="../tyuukai/c0100tyuukai.html">仲介業者様向けTOP</a></dt>
                 <dd><a href="../bukkaku/0790bukkaku.html">物確アミックス</a></dd>
            </dl>
        </div>
        <div class="naviBox">
            <dl>
                 <dt><a href="../about/0800kigyouzyohou.html">企業情報TOP</a></dt>
                 <dd><a href="../about/0880greeting.html">創立60年にあたって</a></dd>
        ...
        <div class="naviBox">
           <dl>
                 ...
                 <dt><a href="../blog/1562/" target="_blank">想続塾</a></dt>
                 <dt><a href="../soudan/">個別無料相談<br><span>（セカンドオピニオンのすすめ）</span></a></dt>
                 <dt><a href="../future/index.html">アミックス将来家賃査定サービス</a></dt>
                 <dt><a href="https://toushi.homes.co.jp/column/author/suenaga-teruo/" target="_blank">不動産投資コラム</a></dt>
                 <dt><a href="https://www.jpm.jp/scp/" target="_blank">賃貸住宅収支計算プログラム</a></dt>
                 <dt><a href="http://www.3-39.com" target="_blank">地域情報サイト339</a></dt>
            </dl>
            <dl class="lastLinks">
            ...
            <dl class="lastLinks">
                <dt><a href="../0500faq.html">よくあるご質問</a></dt>
            </dl>
            <dl class="lastLinks">
                <dt><a href="../0600contact_top.html">お問い合わせ</a></dt>
            </dl>
            <dl class="lastLinks">
                <dt><a href="../0620contact_shiryo">資料請求</a></dt>
            </dl>
            <dl class="lastLinks">
                <dt><a href="../about/0860business.html">ビジネスパートナー募集</a></dt>
            </dl>
            <dl class="lastLinks">
                <dt><a href="../landing/" target="_blank">オーナーズサイト</a></dt>
            </dl>
            <dl class="lastLinks">
                <dt><a href="../about/0850volunteer.html">社会貢献</a></dt>
            </dl>
            <dl class="lastLinks">
