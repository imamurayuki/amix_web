...
// アプリケーションルート
define('APP_URL', 'https://www.amix.co.jp/b0201reform/');
...
define('RESIZE_IMAGE_MIDDLE', '270x180');
define('RESIZE_IMAGE_LARGE', '300x200');
define('RESIZE_IMAGE_SMALL_NO_IMAGE', 'no_image_s.gif');
define('RESIZE_IMAGE_MIDDLE_NO_IMAGE', 'no-image_small.gif');
define('RESIZE_IMAGE_LARGE_NO_IMAGE', 'no-image_large.gif');
