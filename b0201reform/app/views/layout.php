...
<title>リフォーム事例 | 株式会社アミックス</title>
<meta name="Description" content="アパート建築・サブリース管理でオーナー様の資産運用をご提案するアミックス。最適なリフォームにより、さらに長期間の安定収益を確保" />
<meta name="Keywords" content="アパート建築,アパート管理,土地活用,サブリース管理,サブリース,アパート管理,アミックス" />
<link rel="stylesheet" type="text/css" media="all" href="<?php echo APP_URL; ?>css/common/import2.css" />
<link rel="stylesheet" type="text/css" media="print" href="<?php echo APP_URL; ?>css/common/print.css" />
<script type="text/javascript" src="<?php echo APP_URL; ?>js/jquery-1.8.2.min.js"></script>
<script type="text/javascript" src="<?php echo APP_URL; ?>js/common.js"></script>
<script type="text/javascript" src="<?php echo APP_URL; ?>js/jquery.heightLine.js"></script>
<script type="text/javascript">
$(function() {
  $(".heightLine-group1").heightLine();
});
</script>
<link rel="shortcut icon" href="<?php echo APP_URL ?>/img/amix.gif" type="image/gif">
<!--アナリティクスコード　ここから-->
<script>
...
<body id="top" class="reform nowbuild">
...
<div id="header_n">
  <h1 id="siteTitle">
    <p>株式会社アミックス</p>
  	<a href="<?php echo SITE_URL ?>"><img src="<?php echo $base_url ?>/img/logo.png" alt="Amix" /></a>
  </h1>
  <h2 class="six">
  	<a href="<?php echo SITE_URL ?>"><img src="<?php echo $base_url ?>/img/65logo.png" alt="おかげさまで65th Anniversary" /></a>
  </h2>  
  <div class="SP navi">
  	<ul>
    	<li><a href="<?php echo SITE_URL ?>/0600contact_top.html"><img src="<?php echo $base_url ?>/img/spNavi0.png" alt="" /></a></li>
    	<li><a href="<?php echo SITE_URL ?>/0600contact_top.html"><img src="<?php echo $base_url ?>/img/spNavi1.png" alt="" /></a></li>
    	<li class="submenu"><img src="<?php echo $base_url ?>/img/spNavi2.png" alt="submenu" /></li>
    </ul>
  </div>
  <div class="SP">
      <ul id="spSubnavi">
        <li><a href="<?php echo SITE_URL ?>/0600contact_top.html">入居者様サイト</a></li>
        <li><a href="<?php echo SITE_URL ?>/about/0800kigyouzyohou.html">企業情報</a></li>
        <li><a href="<?php echo SITE_URL ?>/0600contact_top.html">お問い合わせ</a></li>
        <li><a href="<?php echo SITE_URL ?>/0500faq.html">よくあるご質問</a></li>
        <li><a href="<?php echo SITE_URL ?>/0620contact_shiryo/">資料請求</a></li>
        <li><a href="<?php echo SITE_URL ?>/0010sitemap.html">サイトマップ</a></li>
      </ul>
      <ul id="spGlobalNavi1">
        <li id="item01"><a href="<?php echo SITE_URL ?>/application/0100tochikatu.html">資産の活用</a></li>
       <li id="item02"><a href="<?php echo SITE_URL ?>/build/0200kenchiku.html">アパート等建築</a></li>
      </ul>
      <ul id="spGlobalNavi2">
        <li id="item03"><a href="<?php echo SITE_URL ?>/build/b0201reform.html">リフォーム</a></li>
        <li id="item04"><a href="<?php echo SITE_URL ?>/manage/0300sublease.html">サブリース管理</a></li>
        <li id="item05"><a href="<?php echo SITE_URL ?>/owner_voice/0370ownervoice.html">オーナー様の声</a></li>
      </ul>
  </div>
  <div class="PC">
      <ul id="subnavi">
        <li class="bn" id="hnavi01"><a href="<?php echo SITE_URL ?>/about/0800kigyouzyohou.html">企業情報</a></li>
        <li id="hnavi02"><a href="<?php echo SITE_URL ?>/0500faq.html">よくあるご質問</a></li>
        <li id="hnavi03"><a href="<?php echo SITE_URL ?>/0010sitemap.html">サイトマップ</a></li>
      </ul>
      <ul id="globalNavi1">
        <li id="item01"><a href="<?php echo SITE_URL ?>/application/0100tochikatu.html">資産の活用</a></li>
        <li id="item02"><a href="<?php echo SITE_URL ?>/build/0200kenchiku.html">アパート等建築</a></li>
      ...
      <ul id="globalNavi2">
        <li id="item06"><a href="<?php echo SITE_URL ?>/0600contact_top.html">入居者様サイト</a></li>
        <li id="item07"><a href="<?php echo SITE_URL ?>/0600contact_top.html">お問い合わせ</a></li>
        <li id="item08"><a href="<?php echo SITE_URL ?>/0620contact_shiryo/">資料請求</a></li>
      </ul>
  </div>
</div>
<!--headerここまで-->
...
<div id="mainVisualArea">
  <div class="img">
    <div class="blue">
      <h1>リフォーム事例</h1>
      <p>最適なリフォームにより<br>さらに長期間の安定収益を確保</p>
    </div>
    <img class="PC" src="<?php echo $base_url ?>/img/main_visual/b0201reform.jpg" alt="リフォーム事例" /> <img class="SP" src="<?php echo $base_url ?>/img/main_visual/b0201reform_spsize.jpg" alt="リフォーム事例" /> </div>
</div>
<!--mainVisualAreaここまで-->
...
<div id="wrapper">
  <div class="wrapInner">
    <div class="contactArea clearfix">
      <ul class="topicPath">
        <li class="pathStart"><a href="<?php echo SITE_URL ?>">ホーム</a></li>
        <li><a href="<?php echo SITE_URL ?>/build/b0201reform.html">アミックスのリフォーム</a></li>
        <?php if (isset($crumb)) {
        echo $crumb;
    } ?>
      </ul>
      <ul class="links PC">
        <li class="tel"><a href="<?php echo SITE_URL ?>/0600contact_top.html"><span class="txt">アパート建築・<br />土地活用のご相談は</span><span class="num">0120-441-432</span></a></li>
        <li class="info"><a href="/build/0291nairankai.html"><span class="txt">アパート内覧会 <span>随時開催</span></span></a></li>
      </ul>
    </div>
  ...
  <div class="contactArea SP">
    <ul class="links clearfix">
      <li class="tel"><a href="<?php echo SITE_URL ?>/0600contact_top.html"><span class="txt">アパート建築・<br />
		  土地活用のご相談は</span><span class="num">0120-441-432</span></a></li>
      <li class="info"><a href="/build/0291nairankai.html"><span class="txt">アパート内覧会 <span>随時開催</span></span></a></li>
    </ul>
  </div>
  <ul class="topicPath">
    <li class="pathStart"><a href="<?php echo SITE_URL ?>/index.html">ホーム</a></li>
    <li><a href="<?php echo SITE_URL ?>/build/b0201reform.html">アミックスのリフォーム</a></li>
    <?php if (isset($crumb)) {
      echo $crumb;
  } ?>
  ...
  <div id="footerNavi">
    <div class="naviBox top clearfix">
      ...
      <dd><a href="/blog/5801/" target="_blank">J-耐震開口フレーム</a></dd>
        ...
        <dl>
          <dt>リフォーム</dt>
          <dd><a href="/build/b0201reform.html">リフォームTOP</a></dd>
          <dd><a href="/b0201reform/">リフォーム事例[外観]</a></dd>
          <dd><a href="/b0201reform/interior">リフォーム事例[内装]</a></dd>
    <dd><a href="/b0201reform/other">リフォーム事例[その他]</a></dd>
          <dd><a href="/0500faq.html#faqBuild">よくあるご質問</a></dd>
        </dl>
        <dl>
          <dt>サブリース管理</dt>
          <dd><a href="/manage/0300sublease.html">サブリース管理TOP</a></dd>
        ...
        <dl>
          <dt><a href="/syuueki/0900ichiran01.html">収益物件</a></dt>
        </dl>
         <dl>
    ...
    <div class="naviBox bottom clearfix">
      <div class="inner">
        ...
        <dl class="wadj">
          <dt><a href="/blog/" target="_blank">社長ブログ</a></dt>
...
<div id="totop"><a href="#top"><img src="<?php echo $base_url ?>/img/sptotop.png" alt="top" /></a></div>
