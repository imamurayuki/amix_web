...
<h2 class="subTitle">リフォーム事例</h2>
  ...
  <div id="tabon" class="tab">
      <ul class="clearfix">
        ...
        <li><p><a href="<?php echo SITE_URL ?>/b0201reform/interior"><span>リフォーム<br class="SP">事例［内装］</span></a></p></li>
        <li class="select"><p><a href="<?php echo SITE_URL ?>/b0201reform/other"><span>リフォーム<br class="SP">事例［その他］</span></a></p></li>
      </ul>
  </div>
