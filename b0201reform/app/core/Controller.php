...
abstract class Controller
{
    ...
    protected function render($variables = array(), $template = null, $layout = 'layout')
    {
        ...
        // [Customize] パン屑が設定できないのでここで無理やり入れる
        if (isset($variables['crumb'])) {
            $defaults['crumb'] = $variables['crumb'];
            unset($variables['crumb']);
        }
        
        if (isset($variables['title'])) {
            $defaults['title'] = $variables['title'];
     ...
     * @return string
     **/
    public function getElement($_path, $_variables = array()) 
    {
        $_file = $this->application->getViewDir() . '/elements/' . $_path . '.php';
