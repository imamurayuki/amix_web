( function( $ ){
    ...
    $.fn.factoryBootstrap455_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap455_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-455 .factory-integer").factoryBootstrap455_integerControl();
    });
