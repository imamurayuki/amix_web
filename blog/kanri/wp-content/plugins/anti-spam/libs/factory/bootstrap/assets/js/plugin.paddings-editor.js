( function( $ ){
    ...
    $.fn.factoryBootstrap455_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap455_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-455 .factory-paddings-editor").factoryBootstrap455_paddingsEditor();
    });
