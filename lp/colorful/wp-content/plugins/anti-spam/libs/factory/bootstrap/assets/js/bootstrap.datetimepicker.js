...
(function(factory) {
	...
	var dateTimePicker = function(element, options) {
		...
		picker.date = function(newDate) {
			///<signature helpKeyword="$.fn.factoryBootstrap455_DatetimePickerControl.date">
			...
			// locid="$.fn.factoryBootstrap455_DatetimePickerControl.date_p:newDate">Takes string, Date, moment, null
		...
		picker.disabledDates = function(dates) {
			///<signature helpKeyword="$.fn.factoryBootstrap455_DatetimePickerControl.disabledDates">
			...
			// name="dates" locid="$.fn.factoryBootstrap455_DatetimePickerControl.disabledDates_p:dates">Takes an [
		...
		picker.enabledDates = function(dates) {
			///<signature helpKeyword="$.fn.factoryBootstrap455_DatetimePickerControl.enabledDates">
			...
			// name="dates" locid="$.fn.factoryBootstrap455_DatetimePickerControl.enabledDates_p:dates">Takes an [
			// string or Date or moment ] of values and allows the user to select only from those days.</param>
			// /</signature>
			if( arguments.length === 0 ) {
		...
		picker.defaultDate = function(defaultDate) {
			///<signature helpKeyword="$.fn.factoryBootstrap455_DatetimePickerControl.defaultDate">
			...
			// locid="$.fn.factoryBootstrap455_DatetimePickerControl.defaultDate_p:defaultDate">Takes a string, Date,
		...
		picker.disabledTimeIntervals = function(disabledTimeIntervals) {
			///<signature helpKeyword="$.fn.factoryBootstrap455_DatetimePickerControl.disabledTimeIntervals">
			///<summary>Returns an array with the currently set disabled dates on the component.</summary>
			...
			///<summary>Setting this takes precedence over options.minDate, options.maxDate configuration. Also calling
			// this function removes the configuration of /options.enabledDates if such exist.</summary> /<param
			// name="dates" locid="$.fn.factoryBootstrap455_DatetimePickerControl.disabledTimeIntervals_p:dates">Takes
		...
		picker.disabledHours = function(hours) {
			///<signature helpKeyword="$.fn.factoryBootstrap455_DatetimePickerControl.disabledHours">
			...
			// name="hours" locid="$.fn.factoryBootstrap455_DatetimePickerControl.disabledHours_p:hours">Takes an [ int
		...
		picker.enabledHours = function(hours) {
			///<signature helpKeyword="$.fn.factoryBootstrap455_DatetimePickerControl.enabledHours">
			...
			// name="hours" locid="$.fn.factoryBootstrap455_DatetimePickerControl.enabledHours_p:hours">Takes an [ int
	 ...
	 * @memberOf jQuery.fn
	 */
	$.fn.factoryBootstrap455_DatetimePickerControl = function(options) {
		options = options || {};
		...
		if( typeof options === 'object' ) {
			return this.each(function() {
				...
				if( !$this.data('DateTimePicker') ) {
					...
					_options = $.extend(true, {}, $.fn.factoryBootstrap455_DatetimePickerControl.defaults, options);
	...
	$.fn.factoryBootstrap455_DatetimePickerControl.defaults = {
		timeZone: '',
		format: false,
	...
	return $.fn.factoryBootstrap455_DatetimePickerControl;
}));
...
( function($) {
	$(function() {
		 ...
		 * Init base controls
		 */
		$(".factory-bootstrap-455 .factory-datetimepicker").factoryBootstrap455_DatetimePickerControl();

		/**
		 * Init range controls
		 */
		$('.factory-bootstrap-455 .factory-datetimepicker-range-0').factoryBootstrap455_DatetimePickerControl();
		$('.factory-bootstrap-455 .factory-datetimepicker-range-1').factoryBootstrap455_DatetimePickerControl({
			useCurrent: false //Important! See issue #1075
		});
		$(".factory-bootstrap-455 .factory-datetimepicker-range-0").on("dp.change", function(e) {
			$('.factory-bootstrap-455 .factory-datetimepicker-range-1').data("DateTimePicker").minDate(e.date);
		});
		$(".factory-bootstrap-455 .factory-datetimepicker-range-1").on("dp.change", function(e) {
			$('.factory-bootstrap-455 .factory-datetimepicker-range-0').data("DateTimePicker").maxDate(e.date);
		});
	});
}(jQuery) );
