( function($) {
	...
	$.fn.factoryBootstrap455_dropdownControl = function(option) {
	...
	$.fn.factoryBootstrap455_dropdownControl.Constructor = DropdownControl;

	// AUTO CREATING
	// ================================

	$(function() {
		$(".factory-bootstrap-455 .factory-dropdown").factoryBootstrap455_dropdownControl();
	});
