( function( $ ){
    ...
    $.fn.factoryBootstrap455_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap455_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-455 .factory-gradient").factoryBootstrap455_gradientControl();
    });
