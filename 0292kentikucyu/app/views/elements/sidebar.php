        ...
        <ul class="pb0">
          ...
          <li class="this"><a href="<?php echo $base_url ?>">ただいま建築中</a>
            ...
            <?php foreach ($data as $item): ?>
              <li><a href="<?php echo $base_url ?>/detail/<?php echo $item['id'] ?>"><?php echo Utils::truncate($item['name'], 20, '…') ?><?php if (isset($newImage) && !empty($newImage)): ?><span class="new">NEW</span><?php endif; ?></a></li>
            <?php endforeach; ?>
            </ul>
            <?php endif; ?>
          </li>
